...
public class FirebaseUtil {
    ...
    public static class Param {
        ...
        public static final String FILTER_TYPE = "fltr_type";
    ...
    public static class Event {
        ...
        public static final String FAV_SELECTION = "fav_select";
        public static final String NEXT_CLICK_EVENT = "nxt_clk";
        public static final String SKIP_CLICK_EVENT = "skp_clk";
        ...
        public static final String SCORE_DETAIL = "score_dtl";
        public static final String SCORE_SHARE = "score_share";
        public static final String SCORE_FILTER = "score_fltr";
        public static final String SCORE_SEARCH = "score_search";
        public static final String SCORE_ODS = "score_odds";
        ...
        public static final String FAV_SCORE_FILTER = "fav_score_fltr";
        public static final String GLOBAL_SEARCH = "global_search";

        public static final String VIEW_PROFILE = "view_profile";
        public static final String NAV_FAV_DETAIL = "nav_fav_dtl";
        public static final String EDIT_SPORTS = "edit_sports";
        public static final String STAFF_PICK_DETAIL = "staff_pick_dtl";
        ...
        public static final String PROFILE_FAV_DETAIL = "prfl_fav_dtl";
     ...
     *
     * @param firebaseAnalytics Instance of Firebase Analytics
