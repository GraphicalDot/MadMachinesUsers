...
public class Constants {
    ...
    public static final long SCORE_REFRESH_TIME_DURATION = 20000;
    ...
    public static final String INTENT_KEY_PUSH = "push_service";
    ...
    public static final String INTENT_POLL_QUESTION = "poll_question";
    ...
    public static final String INTENT_KEY_CURATED = "curated";
}
