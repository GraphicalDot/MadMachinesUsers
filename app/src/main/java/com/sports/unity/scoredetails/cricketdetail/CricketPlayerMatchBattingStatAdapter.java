 ...
 */
public class CricketPlayerMatchBattingStatAdapter extends RecyclerView.Adapter<CricketPlayerMatchBattingStatAdapter.ViewHolder> {

    private final List<CricketPlayerMatchStatDTO> mValues;

    CricketPlayerMatchBattingStatAdapter(List<CricketPlayerMatchStatDTO> mValues) {
