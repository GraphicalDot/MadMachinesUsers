 ...
 */
public class LiveFootballMatchStatHandler {
    ...
    public static LiveFootballMatchStatHandler getInstance(Context context) {
        mContext = context;
        LiveFootballMatchStatHandler completedMatchScoreCardHandler = new LiveFootballMatchStatHandler();
    ...
    private ResponseListener responseListener_ForLoadContent = new ResponseListener() {
        ...
        public void onResponse(String s) {
            ...
            LiveFootballMatchStatHandler.this.handleResponse(s);
        }

        @Override
        public void onErrorResponse(VolleyError volleyError) {
            requestInProcess.remove(REQUEST_TAG);
            LiveFootballMatchStatHandler.this.handleErrorResponse(volleyError);
        }
    };
