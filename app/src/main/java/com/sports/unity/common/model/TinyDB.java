...
/**
 * Created by madmachines on 25/8/15.
 */
...
public class TinyDB {
    ...
    public static final String KEY_SCORE_FILTER_SPORTS_SELECTED = "filter_score_sports_selected";

    public static final String KEY_NEWS_FILTER_SPORTS_SELECTED = "filter_news_sports_selected";
