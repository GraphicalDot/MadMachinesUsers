                ...
                if (responseCode == 200) {
                    ...
                    if (users != null) {
                        ...
                        if (radius != 40000) {
                            ...
                            AlertDialog noUsersNearBy = otherProfileBuilder.create();
                            noUsersNearBy.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                            noUsersNearBy.show();
                            populateProfilePopup(null, view, null, 0);
                        }
                    }
